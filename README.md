...
| `KFLOW_REPO_RUNTIME_PACKAGES` | `mfclshiny=PacificCommunity/mfclshiny@4d5f3c239c0e4e95b9cba068580ec58adf58769a` | Private runtime package checked and installed when the job starts. |
