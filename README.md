...
| `KFLOW_RUNTIME_PACKAGES` | `mfclkit=PacificCommunity/ofp-sam-mfclkit@main,mfclshiny=PacificCommunity/mfclshiny@189994c27d2ae0478a7f954190fdd1c84558c9a6` | Runtime packages checked and installed when the job starts. |
