...
| `KFLOW_RUNTIME_PACKAGES` | `mfclkit=PacificCommunity/ofp-sam-mfclkit@main,mfclshiny=PacificCommunity/mfclshiny@6175d2ffda2231d2e1ef53d219b7cbc4295c6a11` | Runtime packages checked and installed when the job starts. |
