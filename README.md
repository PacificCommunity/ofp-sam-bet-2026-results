...
| `KFLOW_RUNTIME_PACKAGES` | `mfclkit=PacificCommunity/ofp-sam-mfclkit@main,mfclshiny=PacificCommunity/mfclshiny@aa35b7fc9bcaf1362c282e1151b9ba6e2c53bf27` | Runtime packages checked and installed when the job starts. |
