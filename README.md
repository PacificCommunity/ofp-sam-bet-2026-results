...
| `KFLOW_REPO_RUNTIME_PACKAGES` | `mfclshiny=PacificCommunity/mfclshiny@ad434b5ecfeb80bfa5e1b7aca0131ba476a63a9a` | Private runtime package checked and installed when the job starts. |
